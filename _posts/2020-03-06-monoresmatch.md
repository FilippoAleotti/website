...
<div class="mx-auto" style="margin-bottom:-100px">
    <ul class="list-inline">
        ...
        <li>
            <a  style="color:#{{site.color.primary}}; " href="https://vision.deis.unibo.it/~mpoggi/papers/cvpr2019mono.pdf" class="btn-social btn-outline"><i class="fa fa-print fa-2x"></i></a>
        </li>
        <li>
