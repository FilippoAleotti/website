...
<div class="text-center">
 <a  style="color:#{{site.color.primary}};" href="https://filippoaleotti.github.io/demo_live/" class="btn-social btn-outline"><i class="fa fa-2x fa-github">
</div>
...
*NOTE*: Android app will be released soon
</span>

<div class="text-center">
 <a  style="color:#{{site.color.primary}};" href="https://github.com/FilippoAleotti/mobilePydnet" class="btn-social btn-outline"><i class="fa fa-2x fa-github">
</div>
