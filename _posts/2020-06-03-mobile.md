...
<p align="center">
<img alt="webdemo" src="img/works/mobile/webdemo.png">
</p>

<div class="mx-auto" style="margin-bottom:-100px; margin-top:7%">
    <ul class="list-inline">
      <li>
       <a href="https://filippoaleotti.github.io/demo_live/" class="btn btn-outline-info btn-lg ">Try it now</button></a>
       </li>
       <li>
         <a style="color:#{{site.color.primary}};" href="https://github.com/FilippoAleotti/demo_live" class="btn-social btn-outline"<i class="fa fa-2x fa-github"></i></a>
       </li>
</p>
...
<p align="center">
<a style="color:#{{site.color.primary}};" href="https://github.com/FilippoAleotti/mobilePydnet" class="btn-social btn-        outline"><i class="fa fa-2x fa-github"></i></a>
</p>
